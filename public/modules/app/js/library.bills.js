 ...
 */
var form_bills_id = document.getElementById("form_bills_id");
...
function setBillsAlter(id_bills) {
    $.post('/app/finance/select/', {
        id_bills: id_bills
    }, function (data) {
        $.each(data, function (key, value) {
            document.getElementById("form_bills_id").value = id_bills;
            document.getElementById("form_bills_description").value = value.description;
            document.getElementById("form_bills_due_date").value = value.due_date;
            document.getElementById("form_bills_value").value = value.value;
...
button_save_bills.onclick = function () {
    setBills(form_bills_id.value, form_bills_description.value, form_bills_due_date.value, form_bills_value.value);
};